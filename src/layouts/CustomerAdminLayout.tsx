...
const groups=[
 ...
 ['SYSTEM',[['SEO','/admin/seo',Globe],['Domains','/admin/domains',Globe],['Analytics','/admin/analytics',ChartNoAxesCombined],['Audit Logs','/admin/audit-logs',ScrollText],['Notifications','/admin/notifications',Bell],['Email','/admin/email',Mail],['Settings','/admin/settings',Settings],['Security','/admin/security',Shield]]],
] as const;
