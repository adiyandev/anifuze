...
const groups=[
 ...
 ['STREAMING',[['Providers','/admin/providers',Radio],['Provider Console','/admin/providers/console',TerminalSquare],['Diagnostics','/admin/providers/diagnostics',TerminalSquare],['Health','/admin/providers/health',HeartPulse],['Sources','/admin/providers/sources',Database]]],
