...
const groups=[
 ['CONTENT',[['Anime','/admin/anime',Film],['Episodes','/admin/episodes',PlaySquare],['Genres','/admin/genres',Layers],['Collections','/admin/collections',Layers],['Schedule','/admin/schedule',CalendarDays]]],
