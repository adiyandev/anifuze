...
const groups=[
 ...
 ['SYSTEM',[['SEO','/admin/seo',Globe],['Domains','/admin/domains',Globe],['Analytics','/admin/analytics',ChartNoAxesCombined],['Audit Logs','/admin/audit-logs',ScrollText],['Backups','/admin/backups',Database],['System Info','/admin/system-info',Server],['Cache','/admin/cache',Database],['Maintenance','/admin/maintenance',Settings],['Notifications','/admin/notifications',Bell],['Email','/admin/email',Mail],['Settings','/admin/settings',Settings],['Security','/admin/security',Shield]]],
] as const;
