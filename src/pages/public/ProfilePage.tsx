...
export function ProfilePage(){
 ...
 const [saved,setSaved]=useState(false); const [cleared,setCleared]=useState(false);
 ...
 const clearHistory=()=>{watchProgressService.clear();setHistory([]);setCleared(true);setTimeout(()=>setCleared(false),1800)};
