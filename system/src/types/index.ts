...
export interface Anime {id:string;title:string;type:string;status:string;episodes:number;views:string;genre:string;description:string;cover:string;banner?:string;score?:number;ratingSource?:'anilist';ratingScale?:10;year?:number}
