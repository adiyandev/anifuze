...
const groups=[
 ...
 ['STREAMING',[['Providers','/admin/providers',Radio],['Provider Marketplace','/admin/providers/marketplace',ShoppingBag],['Provider Console','/admin/providers/console',TerminalSquare],['Diagnostics','/admin/providers/diagnostics',TerminalSquare],['Health','/admin/providers/health',HeartPulse],['Sources','/admin/providers/sources',Database]]],
 ...
 ['SYSTEM',[['SEO','/admin/seo',Globe],['Domains','/admin/domains',Globe],['Analytics','/admin/analytics',ChartNoAxesCombined],['Audit Logs','/admin/audit-logs',ScrollText],['Backups','/admin/backups',Database],['System Info','/admin/system-info',Server],['Cache','/admin/cache',Database],['Maintenance','/admin/maintenance',Settings],['Updates','/admin/updates',Server],['Licensing','/admin/license',Shield],['Support','/admin/support',MessageSquare],['Notifications','/admin/notifications',Bell],['Email','/admin/email',Mail],['OAuth','/admin/oauth',Shield],['Settings','/admin/settings',Settings],['Security','/admin/security',Shield]]],
] as const;
