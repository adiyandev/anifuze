...
export function PublicLayout(){
 ...
 const templateConfig=template?.config&&typeof template.config==='object'?template.config:{};const primary=templateConfig.primary||templateConfig.primaryColor||settings.primary;const accent=templateConfig.accent||templateConfig.accentColor||settings.accent;return <div className="vault-shell" data-template={template?.id||undefined} style={{'--vault-primary':primary,'--vault-accent':accent} as CSSProperties}>
