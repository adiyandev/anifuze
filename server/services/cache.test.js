...
test('cache expires entries',async()=>{cacheClear();cacheSet('expires','value',1);await new Promise(r=>setTimeout(r,5));assert.equal(cacheGet('expires'),undefined);cacheClear()});
