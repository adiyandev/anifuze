export const ADMIN_PERMISSIONS=Object.freeze({
  ...
  analytics_view:['owner','admin'], notifications_manage:['owner','admin'], email_manage:['owner','admin'], settings_manage:['owner','admin'], security_manage:['owner','admin'], audit_view:['owner','admin'], system_view:['owner','admin'], cache_manage:['owner','admin'],
